...
- **DSH-WM**, "DSH-WM: A playable world-model toolkit for DeepSeek Harness — inspect frames, name 3D / pixel / latent routes, and score pred vs GT". [![Code](https://img.shields.io/badge/Code-GitHub-green)](https://github.com/WayneJin0918/dsh-wm)
